...
class MySQL():
    ...
    def updateGOF_commit(self):
        ...
        cursor.execute("SELECT * FROM quotations WHERE Books_Book_ID = (%s)", (primKey,))
        # print(cursor.fetchall())
        cursor.execute("UPDATE quotations SET Quotation = '1' WHERE Books_Book_ID = 2")
        # cursor.execute("UPDATE quotations SET Quotation =(test2222) WHERE Books_Book_ID = (%s)",(primKey))
